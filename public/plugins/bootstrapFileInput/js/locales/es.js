...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgInvalidFileType: 'Tipo de archivo no válido.',
        msgInvalidFileExtension: 'Extensión de archivo no válida para "{name}". Sólo archivos "{extensions}" son permitidos.',
        ...
        fileActionSettings: {
            ...
            indicatorErrorTitle: 'Error de archivo',
