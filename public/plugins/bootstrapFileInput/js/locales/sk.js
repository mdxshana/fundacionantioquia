...
(function ($) {
    ...
    $.fn.fileinputLocales['sk'] = {
        ...
        msgImageWidthSmall: 'Šírka img súboru "{name}", musí byť minimálne {size} px.',
        msgImageHeightSmall: 'Výška img súboru "{name}", musí byť minimálne {size} px.',
        msgImageWidthLarge: 'Šírka img súboru "{name}" nemôže presiahnuť {size} px.',
