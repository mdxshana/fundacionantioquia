...
(function ($) {
    ...
    $.fn.fileinputLocales['hu'] = {
        ...
        msgImageWidthSmall: 'Szélessége img file "{name}" legalább {size} px.',
        msgImageHeightSmall: 'Magassága img file "{name}" legalább {size} px.',
        msgImageWidthLarge: 'Szélessége img file "{name}" nem haladhatja meg a {size} px.',
        msgImageHeightLarge: 'Magassága img file "{name}" nem haladhatja meg a {size} px.',
