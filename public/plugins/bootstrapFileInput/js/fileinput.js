...
(function (factory) {
    ...
    tImage = '<img src="{data}" class="kv-preview-data file-preview-img" title="{caption}" alt="{caption}" ' +
        STYLE_SETTING + '>\n';
    ...
    $.fn.fileinput.defaults = {
        ...
        resizeQuality: 0.92,
        resizeDefaultImageType: 'img/jpeg',
        maxFileSize: 0,
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgImageWidthSmall: 'Width of img file "{name}" must be at least {size} px.',
        msgImageHeightSmall: 'Height of img file "{name}" must be at least {size} px.',
        msgImageWidthLarge: 'Width of img file "{name}" cannot exceed {size} px.',
        msgImageHeightLarge: 'Height of img file "{name}" cannot exceed {size} px.',
        msgImageResizeError: 'Could not get the img dimensions to resize.',
        msgImageResizeException: 'Error while resizing the img.<pre>{errors}</pre>',
